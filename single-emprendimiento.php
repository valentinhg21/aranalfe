...
<main class="template-emprendimiento ">
    ...
    <section class="section-7">
        <div class="container d-flex flex-row-md flex-column justify-between align-items-start">
            ...
            <div class="cont-form">
                <form action="" data-origen="Form Emprendimiento" class="w-100 form-contacto p-relative" id="singleFormDevelopment" data-property="<?php echo $current_id?>" data-tags="Consulta de emprendimiento">
