...
//FILTRO 
$order_by_slug = isset($_GET['order_by']) ? sanitize_text_field($_GET['order_by']) : 'created_date';
$order_slug = isset($_GET['order']) ? sanitize_text_field($_GET['order']) : 'asc';
...
<main class="properties" data-id="" data-page="<?php echo $page;?>" data-current="<?php echo $offset;?>"
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-3  col-sm-3 col-12 col-filtros">
