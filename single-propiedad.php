...
$property = get_details_property($current_id)['objects'][0];
$images = get_images_details_property($current_id);
// Price
...
$type_property_id = $property['type']['id'];
// DIMENSION
$total_surface = $property['total_surface'];
$semi_surface = $property['semiroofed_surface'];
...
$address_id = $property['location']['id'];
...
$params = [
    'data' => [
        ...
        'filters' => [], // filtros extra si querés
        'with_tags' => []
    ]
];
$property_similar = get_all_property_by_filter($params, 4, 0);
$property_similar_filter = array_values(array_filter($property_similar['objects'], function($property) use ($current_id) {
    return $property['id'] != $current_id;
}));

$class_property_similar = 'col-xxl-3 col-md-4 col-sm-6 col-12';

if(count($property_similar_filter ) <= 3){
    $class_property_similar = 'col-xxl-4 col-md-4 col-sm-6 col-12';
}
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="body-content">
                    ...
                    <div class="details">
                        ...
                        <?php if($description_text):?>
                            <div class="item">
                                <h2>Descripción</h2>
                                <?php echo preg_replace('/<p>\s*(<br\s*\/?>)?\s*<\/p>/i', '', $description_text); ?>
            ...
            <aside class="col-sm-5 col-12" id="containerFormRequest">
                <form id="singlePropertyForm" data-origen="Form Propiedad" data-property="<?php echo $current_id?>" data-tags="Consulta de propiedad">
