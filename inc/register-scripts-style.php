...
function zetenta_theme_styles(){
    ...
    wp_register_style('zetenta-styles', get_stylesheet_uri(), array('fontawesome', 'sweetalert2-css', 'leaflet-css', 'splide-css', 'fancybox-css', 'splide-css'), '1.0', 'all');
...
function zetenta_theme_scripts(){
    ...
    wp_register_script( 'zetenta-scripts', JS . '/index.min.js', array('sm-3-scripts','selects-js', 'leaflet', 'tokko-js', 'validator', 'sweetalert2-js', 'splide-js', 'fancybox-js', 'swiper-js'), '1.0', true);
