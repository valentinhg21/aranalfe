...
function zetenta_theme_styles(){
    ...
    wp_register_style('zetenta-styles', get_stylesheet_uri(), array('fontawesome', 'sweetalert2-css'), '1.0', 'all');
...
function zetenta_theme_scripts(){
    ...
    wp_register_script( 'zetenta-scripts', JS . '/index.min.js', array('sm-3-scripts','selects-js', 'tokko-js', 'validator', 'sweetalert2-js'), '1.0', true);
